...
WebUI.click(findTestObject('cart/Page_Swag Labs/button_Remove', [('productName') : 'sauce-labs-backpack']))

WebUI.verifyElementText(findTestObject('cart/Page_Swag Labs/Page_Swag Labs/cart'), '1')

WebUI.click(findTestObject('cart/Page_Swag Labs/button_Remove', [('productName') : 'sauce-labs-bike-light']))
